...
- [x] 2. Utility fonksiyonları ve property testleri
  ...
  - [x]* 2.2 Write property tests in `frontend/src/market-prices/__tests__/formatters.property.test.ts`
  ...
  - [x]* 2.3 Write property tests in `frontend/src/market-prices/__tests__/urlState.property.test.ts`
...
- [x] 4. API client katmanı
  ...
  - [x]* 4.2 Write unit tests in `frontend/src/market-prices/__tests__/marketPricesApi.test.ts`
...
- [x] 5. Custom hooks
  ...
  - [x] 5.2 Create `frontend/src/market-prices/hooks/useMarketPricesList.ts` — fetch on params change, AbortController for cancellation, loading/error/data state, refetch function
    - _Requirements: 1.1, 1.7, 3.5, 11.1, 11.5_
  ...
  - [x]* 5.5 Write property tests in `frontend/src/market-prices/__tests__/listState.property.test.ts`
...
- [x] 9. Upsert form modal
  ...
  - [x]* 9.2 Write property tests in `frontend/src/market-prices/__tests__/validation.property.test.ts`
  ...
  - [x]* 9.3 Write property tests in `frontend/src/market-prices/__tests__/errorMapping.property.test.ts`
...
- [x] 10. Bulk import wizard
  ...
  - [x]* 10.2 Write property tests in `frontend/src/market-prices/__tests__/bulkImport.property.test.ts`
...
- [x] 12. MarketPricesTab orkestratör ve AdminPanel entegrasyonu
  ...
  - [x] 12.2 Update `frontend/src/AdminPanel.tsx` — remove inline MarketPricesTab function, import new MarketPricesTab from `./market-prices/MarketPricesTab`, replace usage in render. Remove old market price state variables and handler functions that are no longer needed. Keep all other tabs untouched.
    - _Requirements: 10.1, 10.2, 10.3_
  - [x] 12.3 Update `frontend/src/api.ts` — keep old getMarketPrices, upsertMarketPrice, lockMarketPrice, unlockMarketPrice functions for backward compatibility but add @deprecated JSDoc comments. No functional changes needed since new API client is in marketPricesApi.ts.
    - _Requirements: 9.1_
